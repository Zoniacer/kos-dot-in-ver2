      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">Kos.In memanfaatkan teknologi untuk mengembangkan aplikasi cari kos agar menjadi aplikasi yang memudahkan 
			calon anak kos untuk booking properti kos dan juga melakukan pembayaran kos. Kos.In berharap agar dapat memudahkan
			pemilik kos untuk mendapatkan calon anak kos secepat mungkin. Kos.In berusaha untuk bisa terus menyajikan daftar rumah kos dengan data ketersediaan 
			kamar yang akurat, fasilitas kos terperinci, dan dilengkapi dengan foto serta detail harga kos agar calon penghuni mendapatkan 
